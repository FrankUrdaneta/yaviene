            ...
            if (this.e == null) {
                ...
                const arrastrar = e=>{
                    ...
                    const move = (e) => {
                        ...
                        if(posy > window.innerHeight - dialogo.offsetHeight /2 && this.configuracion.top == null) {
                ...
                if (this.configuracion.top != null) {
                    dialogo.style.top = (parseInt(this.configuracion.top) + parseInt(window.pageYOffset)) + 'px'; // (this.configuracion.top) + 'px';
                } else {
                    dialogo.style.top = (window.innerHeight - dialogo.offsetHeight) / 2 + 'px';
                }
                ...
                if (this.ntop && this.configuracion.top == null){
                    dialogo.style.top = this.ntop + 'px';
                }
                if (this.nleft && this.configuracion.left == null){
